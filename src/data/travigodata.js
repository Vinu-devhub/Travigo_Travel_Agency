...
export const hero = {
  ...
  subtitle: "There, Go Explore",
  text: "We always make our customers happy by proving many choices.",
  btn1: "Get Started",
  btn2: "Get a Demo",
  img: dashboard,
};
...
export const placesAPI = [
  { placeImg: place1, location: "Varanasi", distance: "3.0 hour dirve" },
  { placeImg: place2, location: "Sikkim", distance: "2.5 hour dirve" },
  { placeImg: place3, location: "Nashik", distance: "4.7 hour drive" },
  { placeImg: place4, location: "Goa", distance: "4 hour drive" },
  { placeImg: place5, location: "Ooty", distance: "4.9 hour drive" },
  { placeImg: place6, location: "Gulmarg", distance: "4.5 hour drive" },
  { placeImg: place7, location: "Manali", distance: "5.5 hour drive" },
  { placeImg: place8, location: "Coorg", distance: "5.1 hour drive" },
  { placeImg: place9, location: "Lonavala ", distance: "5.1 hour drive" },
  { placeImg: place10, location: "Munnar", distance: "5.1 hour drive" },
];
...
export const bannerAPI = {
  ...
  text: "Wishlist Curated By Travigo.",
  imgSrc: banner,
