                ...
                <div className='grid items-center grid-cols-3 gap-7 xl:gap-3'>
                    {
                        experience?.map((item, index) => (
                            <div key={index} className="bg-gradient-to-b from-emerald-300 to-green-300 shadow-lg shadow-emerald-200 flex items-center justify-center flex-col py-7 px-5 xl:p-5 rounded-lg text-slate-900 filter cursor-pointer hover:scale-105 transition-all duration-300">
